...
interface Participacion {
  ...
  fecha: string
  nombreEvento: string
  tipoParticipacion: 'Concurso' | 'Anfitrión' | 'Invitado'
  cosplayName?: string
}
    ...
    const fetchEventos = async () => {
      ...
      try {
        ...
        const mapped = (data || []).map((e: any) => ({
          ...
          tipoParticipacion: (e.type as Participacion['tipoParticipacion']) || 'Concurso',
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-violet-500/30 bg-violet-950/30">
                <th className="px-6 py-4 text-left text-sm font-bold font-[family-name:var(--font-orbitron)] text-violet-300 uppercase tracking-wider">
                ...
                participaciones.map((participacion, index) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      <span
                        className={`inline-flex items-center gap-2 px-3 py-1 rounded-full text-xs font-[family-name:var(--font-orbitron)] uppercase tracking-wider border ${getParticipacionColor(
